...
We validated a phylogenetics-based analysis pipeline to infer person-to-person (P2P) transmission relationships and infection dates from 139 patient HIV-1 polymerase Sanger sequences curated by the Southern Alberta HIV Clinic. The pipeline has three steps: 1) multiple sequence alignment, 2) rooted phylogenetic tree generation, and 3) transmission and infection date inference).
